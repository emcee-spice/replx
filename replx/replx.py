...
"""
    ...
    def student_view(self, context=None):
        ...
        frag.add_javascript(self.resource_string("static/js/lib/codemirror-repl/codemirror-repl.js"))
        ...
        frag.add_javascript(self.resource_string("static/js/src/repl.js"))
